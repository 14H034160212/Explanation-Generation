...
SFT=./rl_sft_qwen3_8b_cardiff_tierC_generator
DPO=./rl_dpo_qwen3_8b_cardiff_tierC_generator
PREF=./rl_preference_data_qwen3_cardiff_tierC
...
$PY scripts/python_training/rl_evaluate_qwen3.py \
  ...
  --dpo_lora_path $DPO \
  --verifier_path $VERIFIER \
  --output_path ./rl_eval_results/qwen3_cardiff_tierC_eval.json \
  --device cuda:0 --verifier_device cuda:0 --nli_device cpu

touch /data/qbao775/Explanation-Generation/.tierC_qwen3_cardiff_DONE
echo "=== DONE ==="
