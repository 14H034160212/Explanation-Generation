...
declare -a EXPERIMENT_QUEUE=(
    ...
    "any|rl_ppo_qwen3_dpo_v1_beta05_generator|rl_qwen3_ppo_dpo_v1_beta05.log|python3 rl_train_ppo_qwen3.py --model_name_or_path /data/shared/qwen3/Qwen3-8B --sft_adapter_path ./rl_dpo_qwen3_v1_beta05_generator --verifier_path ./qiming_alpaca_7B_Cardiff_Sydney_merged_verifier_way_2 --data_path ./Paul_new_data/Merged_Sydney_Cardiff_Law_Medical_Y1_Y2/generator_merged_avg_3_lenexp_10.json --output_dir ./rl_ppo_qwen3_dpo_v1_beta05_generator --batch_size 4 --mini_batch_size 1 --learning_rate 1e-5 --max_questions 2000 --verifier_device cuda:0"
    "any|rl_ppo_qwen3_dpo_v2_beta05_generator|rl_qwen3_ppo_dpo_v2_beta05.log|python3 rl_train_ppo_qwen3.py --model_name_or_path /data/shared/qwen3/Qwen3-8B --sft_adapter_path ./rl_dpo_qwen3_v2_beta05_generator --verifier_path ./qiming_alpaca_7B_Cardiff_Sydney_merged_verifier_way_2 --data_path ./Paul_new_data/Merged_Sydney_Cardiff_Law_Medical_Y1_Y2/generator_merged_avg_3_lenexp_10.json --output_dir ./rl_ppo_qwen3_dpo_v2_beta05_generator --batch_size 4 --mini_batch_size 1 --learning_rate 1e-5 --max_questions 2000 --verifier_device cuda:0"
    "any|rl_ppo_qwen3_sft_lr5e5_generator|rl_qwen3_ppo_sft_lr5e5.log|python3 rl_train_ppo_qwen3.py --model_name_or_path /data/shared/qwen3/Qwen3-8B --sft_adapter_path ./rl_sft_qwen3_8b_generator --verifier_path ./qiming_alpaca_7B_Cardiff_Sydney_merged_verifier_way_2 --data_path ./Paul_new_data/Merged_Sydney_Cardiff_Law_Medical_Y1_Y2/generator_merged_avg_3_lenexp_10.json --output_dir ./rl_ppo_qwen3_sft_lr5e5_generator --batch_size 4 --mini_batch_size 1 --learning_rate 5e-5 --max_questions 2000 --verifier_device cuda:0"
)
