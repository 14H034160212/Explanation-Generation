...
Uses Qwen3 chat template (enable_thinking=False).
...
def main():
    ...
    parser.add_argument("--sft_lora_path", default="./rl_sft_qwen3_8b_generator")
    ...
    parser.add_argument("--output_path", default="./rl_eval_results/qwen3_eval.json")
    ...
    all_results = []
    models_to_eval = [("Qwen3-8B-SFT", args.sft_lora_path)]
    if args.dpo_lora_path and os.path.exists(args.dpo_lora_path):
        models_to_eval.append(("Qwen3-8B-DPO", args.dpo_lora_path))
