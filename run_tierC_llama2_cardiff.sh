...
SFT=./rl_sft_llama2_13b_cardiff_tierC_generator
DPO=./rl_dpo_llama2_13b_cardiff_tierC_generator
PREF=./rl_preference_data_llama2_cardiff_tierC
...
$PY scripts/python_training/rl_evaluation.py \
  ...
  --verifier_path $VERIFIER \
  --output_path ./rl_eval_results/llama2_cardiff_tierC_eval.json \
  --device cuda:0 --verifier_device cuda:0 --nli_device cpu

touch /data/qbao775/Explanation-Generation/.tierC_llama2_cardiff_DONE
echo "=== DONE llama2 cardiff tierC ==="
