...
\filldraw[orange] (4.3,3.7) circle (4pt) node[right=0.3cm] {\textbf{RLearner-LLM (Ours)}};

% Annotations
\draw[<->, red, thick] (1.2,4.8) -- (5.8,1.2) node[pos=0.5, sloped, above=0.25cm] {\textbf{Alignment Tax}};
