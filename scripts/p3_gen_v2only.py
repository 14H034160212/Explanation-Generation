...
BASE="google/gemma-4-E4B-it"; ADAPTER="./rl_dpo_gemma4_e4b_cardiff_reasoning_v2_generator"
...
g=d.get("generations",d); g["reasoningDPO_v2"]=gens
...
open(".p3_v2gen_DONE","w").write("done")
