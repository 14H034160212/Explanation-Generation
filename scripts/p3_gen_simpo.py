...
BASE="google/gemma-4-E4B-it"; ADAPTER="./rl_dpo_gemma4_e4b_cardiff_reasoning_simpo_generator"
...
g=d.get("generations",d); g["reasoningSimPO"]=gens
...
open(".p3_simpogen_DONE","w").write("done")
