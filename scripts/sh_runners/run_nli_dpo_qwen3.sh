#!/bin/bash
# =============================================================================
# Phase 1: NLI-Guided DPO for Qwen3-8B
# Purpose: Fix alignment tax — use NLI entailment as preference ranking signal
#          instead of Alpaca-7B verifier score.
#
# Expected result: Qwen3 DPO-NLI should NOT drop NLI score after DPO
#                  (vs old DPO: SFT 0.196 → DPO 0.115, a regression)
#
# Usage:
#   bash run_nli_dpo_qwen3.sh
# =============================================================================
...
PREF_OUT=./rl_preference_data_nli_qwen3/preference_pairs.json
DPO_OUT=./rl_dpo_qwen3_nli_generator
...
EVAL_CARDIFF=./rl_eval_results/qwen3_dpo_nli_cardiff_eval.json
EVAL_SYDNEY=./rl_eval_results/qwen3_dpo_nli_sydney_eval.json

echo "============================================================"
echo "Phase 1A: Build NLI preference pairs (Qwen3-8B)"
echo "============================================================"
...
echo ""
echo "============================================================"
echo "Phase 1B: DPO training with NLI preference pairs (Qwen3-8B)"
echo "============================================================"
...
echo ""
echo "============================================================"
echo "Phase 1C: Evaluate Qwen3-8B DPO-NLI (Cardiff)"
echo "============================================================"
...
echo ""
echo "============================================================"
echo "Phase 1D: Evaluate Qwen3-8B DPO-NLI (Sydney)"
echo "============================================================"
CUDA_VISIBLE_DEVICES=6,7 $PYTHON rl_evaluate_qwen3.py \
    --base_model_path "$BASE_MODEL" \
    --sft_lora_path "$SFT_ADAPTER" \
...
print("Qwen3 DPO-NLI results:")
show("CARDIFF", "./rl_eval_results/qwen3_dpo_nli_cardiff_eval.json")
show("SYDNEY",  "./rl_eval_results/qwen3_dpo_nli_sydney_eval.json")

print("\nBaseline comparison (old DPO with verifier reward):")
show("CARDIFF", "./rl_eval_results/qwen3_ppo_cardiff_eval.json")
show("SYDNEY",  "./rl_eval_results/qwen3_ppo_sydney_eval.json")
PYEOF
