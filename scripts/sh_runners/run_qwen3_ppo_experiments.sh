...
CUDA_VISIBLE_DEVICES=7 python3 scripts/python_training/rl_train_ppo_qwen3.py \
...
CUDA_VISIBLE_DEVICES=6 python3 scripts/python_training/rl_train_ppo_qwen3.py \
    --model_name_or_path "${BASE_MODEL}" \
