...
env CUDA_VISIBLE_DEVICES=4 conda run --no-capture-output -n qwen3-rl python3 scripts/python_training/rl_train_dpo_qwen3.py \
    --model_name_or_path /data/shared/qwen3/Qwen3-8B \
    --sft_adapter_path ./models/rl_sft_qwen3_8b_generator \
    --preference_data_path ./preference_data/rl_preference_data/preference_pairs.json \
    --output_dir ./models/rl_dpo_qwen3_v1_generator \
    --num_train_epochs 5 \
...
env CUDA_VISIBLE_DEVICES=4 conda run --no-capture-output -n qwen3-rl python3 scripts/python_training/rl_train_dpo_qwen3.py \
    --model_name_or_path /data/shared/qwen3/Qwen3-8B \
    --sft_adapter_path ./models/rl_sft_qwen3_8b_generator \
    --preference_data_path ./preference_data/rl_preference_data_v2/preference_pairs.json \
    --output_dir ./models/rl_dpo_qwen3_v2_generator \
    --num_train_epochs 5 \
    --per_device_train_batch_size 1 \
    --max_steps 2000 \
    --learning_rate 5e-6 \
...
env CUDA_VISIBLE_DEVICES=6 conda run --no-capture-output -n qwen3-rl python3 scripts/python_training/rl_train_ppo_qwen3.py \
    --model_name_or_path /data/shared/qwen3/Qwen3-8B \
    --sft_adapter_path ./models/rl_dpo_qwen3_8b_generator \
    ...
    --output_dir ./models/rl_ppo_qwen3_hybrid_dpo_ppo_generator \
    --batch_size 4 \
    --mini_batch_size 1 \
    --learning_rate 1e-5 \
    --max_questions 2000 \
...
env CUDA_VISIBLE_DEVICES=7 conda run --no-capture-output -n qwen3-rl python3 scripts/python_training/rl_train_ppo_qwen3.py \
    --model_name_or_path /data/shared/qwen3/Qwen3-8B \
    --sft_adapter_path ./models/rl_sft_qwen3_8b_generator \
    --verifier_path ./qiming_alpaca_7B_Cardiff_Sydney_merged_verifier_way_2 \
    --data_path ./preference_data/Paul_new_data/Merged_Sydney_Cardiff_Law_Medical_Y1_Y2/generator_merged_avg_3_lenexp_10.json \
    --output_dir ./models/rl_ppo_qwen3_sft_ppo_generator \
    --batch_size 4 \
    --mini_batch_size 1 \
    --learning_rate 1e-5 \
    --max_questions 2000 \
