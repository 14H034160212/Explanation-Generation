...
load_model_name_list = ["./llama_2_13B_auckland_law_evaluator"]
...
cardiff_all_question = pd.read_json(path_list[0]+"evaluator_Test_auckland_law.json")
...
# tag5 = "Llama_2_13B_auckland_law_merged_evaluator_"
tag4 = "Llama_2_13B_auckland_law_evaluator_"
# tag4 = "Llama_2_13B_auckland_law_merged_evaluator_"
...
total_list = [tag4+"Auckland_law_test"]
            #   tag5+"Auckland_law_test"]
