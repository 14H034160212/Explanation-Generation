...
# load_model_name_list = ["./vicuna-13b/", "./vicuna_13B_UK_medical_year2_all_generator_avg_3_lenexp_10"]
...
cardiff_all_question = pd.read_json(path_list[0]+"Medicine_year2_vicuna_13b_finetuned_random_100.json")
...
# tag4 = "Vicuna_13B_UK_medical_year2_generator_"
# tag5 = "Fine_tuned_Vicuna_13B_UK_medical_year2_generator_"
tag4 = "Fine_tuned_llama_2_13B_chat_UK_medical_year2_generator_"
...
total_list = [tag4+"UK_medical_year2_test_question_generated_explanation"]
            #   tag5+"UK_medical_year2_test_question_generated_explanation"]
