...
cardiff_all_question = pd.read_json(path_list[0]+"Auckland_law_vicuna_13b_finetuned_random_100.json")
...
tag4 = "Fine_tuned_llama_2_13B_chat_Auckland_law_generator_"
...
total_list = [tag4+"Auckland_law_test_question_generated_explanation"]
            #   tag5+"Auckland_law_test_question_generated_explanation"]
