...
name_list = ["uk_medicine_all_questions"]
...
total_questions = [year1, Year_1_2015, Year_1_2016, Year_1_2017, Year_1_2018, Year_1_2019, Year_1_2020_21]
total_list = [cardiff_all_question_list]
...
with open('./PeerWiseData/Medicine/UK_medicine_year2_merged_verifier_way_2.json', "w") as f:
    json.dump(final_total_list, f, indent=4)
