...
cardiff_all_question=pd.read_excel('./PeerWiseData/Law/Questions.xlsx')
...
name_list = ["auckland_law_all_questions"]
...
with open('./PeerWiseData/Law/Auckland_law_merged_verifier_way_2.json', "w") as f:
    json.dump(final_total_list, f, indent=4)
