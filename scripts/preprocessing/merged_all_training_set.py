...
test_sets = [sydney_test, cardiff_test, auckland_law_test, uk_medical_year1_test, uk_medical_year2_test]
test = pd.concat(test_sets)

# 合并所有的训练集
train_sets = [sydney_training, cardiff_training, auckland_law_training, uk_medical_year1_training, uk_medical_year2_training]
...
# 将字典列表保存为JSON文件
with open('./Paul_new_data/Merged_Sydney_Cardiff_Law_Medical_Y1_Y2/generator_merged_avg_3_lenexp_10.json', 'w') as f:
...
# 将字典列表保存为JSON文件
with open('./Paul_new_data/Merged_Sydney_Cardiff_Law_Medical_Y1_Y2/Sydney_all_generator_train_avg_3_lenexp_10.json', 'w') as f:
...
# 将字典列表保存为JSON文件
with open('./Paul_new_data/Merged_Sydney_Cardiff_Law_Medical_Y1_Y2/Cardiff_all_generator_train_avg_3_lenexp_10.json', 'w') as f:
...
# 将字典列表保存为JSON文件
with open('./Paul_new_data/Merged_Sydney_Cardiff_Law_Medical_Y1_Y2/Auckland_law_all_generator_train_avg_3_lenexp_10.json', 'w') as f:
...
# 将字典列表保存为JSON文件
with open('./Paul_new_data/Merged_Sydney_Cardiff_Law_Medical_Y1_Y2/UK_medical_year1_all_generator_train_avg_3_lenexp_10.json', 'w') as f:
...
# 将字典列表保存为JSON文件
with open('./Paul_new_data/Merged_Sydney_Cardiff_Law_Medical_Y1_Y2/UK_medical_year2_all_generator_train_avg_3_lenexp_10.json', 'w') as f:
