...
COMPARISONS=[("reasoningOPD_fixed","SFT"),("reasoningSimPO_fixed","SFT"),("reasoningDPO_v2_fixed","SFT")]
...
for model in JUDGES:
    for (A,B) in COMPARISONS:
        ...
        json.dump(out,open("rl_eval_results/p3_judge_compare_fixed.json","w"),indent=2)
open(".p3_judgefixed_DONE","w").write("done")
print("SAVED rl_eval_results/p3_judge_compare_fixed.json")
