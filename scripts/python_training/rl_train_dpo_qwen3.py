...
# DPO arguments are now handled by trl.DPOConfig
...
def load_preference_data(data_path: str) -> Dataset:
    ...
    # Standard columns: prompt, chosen, rejected
...
def main():
    ...
    # Set some defaults in training_args if not provided
    ...
    # ── DPO Training (Modern TRL API) ─────────────────────────────────────────────
    # DPOTrainer handles collation internally in modern versions.
