...
env CUDA_VISIBLE_DEVICES=5 conda run --no-capture-output -n qwen3-rl python3 rl_train_dpo_qwen3.py \
...
env CUDA_VISIBLE_DEVICES=4 conda run --no-capture-output -n qwen3-rl python3 rl_train_dpo_qwen3.py \
    --model_name_or_path /data/shared/qwen3/Qwen3-8B \
    --sft_adapter_path ./rl_sft_qwen3_8b_generator \
...
env CUDA_VISIBLE_DEVICES=6 conda run --no-capture-output -n qwen3-rl python3 rl_train_ppo_qwen3.py \
    --model_name_or_path /data/shared/qwen3/Qwen3-8B \
...
env CUDA_VISIBLE_DEVICES=7 conda run --no-capture-output -n qwen3-rl python3 rl_train_ppo_qwen3.py \
    --model_name_or_path /data/shared/qwen3/Qwen3-8B \
    --sft_adapter_path ./rl_sft_qwen3_8b_generator \
    --verifier_path ./qiming_alpaca_7B_Cardiff_Sydney_merged_verifier_way_2 \
    --data_path ./Paul_new_data/Merged_Sydney_Cardiff_Law_Medical_Y1_Y2/generator_merged_avg_3_lenexp_10.json \
